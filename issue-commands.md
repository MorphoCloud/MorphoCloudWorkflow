...
| `/recreate_volume` | Recreate volume for an existing instance (after `/delete_volume`). | Issue creator, Admin |
...
_Once approved, the issue creator can run `/create`, `/recreate_volume`,
`/delete_instance`, `/delete_volume`, and `/delete_all`._
